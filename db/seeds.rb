...
user1 =      User.create!  :id=>1,  :username =>'toto', :email => 'toto@toto.com',    :password => '', :password_confirmation => ''
...
user2 =       User.create!  :id=>2,  :username =>'tata', :email => 'tata@tata.com',    :password => '', :password_confirmation => ''
